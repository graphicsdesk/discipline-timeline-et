...
module.exports = {
  "name": "discipline-timeline-et",
  "version": "0.0.0",
  "private": true,
  "scripts": {
    "start": "parcel src/index.html --global script",
    "build": "parcel build src/index.html --global script --public-url https://spectator-static-assets.s3.amazonaws.com/discipline-timeline-et --no-content-hash",
  ...
  "spectate": {
    ...
    "USE_COVER_HED": true,
    "IS_EMBED": false,
    "DOC_URL": "https://docs.google.com/document/d/1W7fjyCDI__-NkCAO6X_Owjir61BSsKy4RnfvDB1tU80/edit?usp=sharing"
  }
};
...
var SECTION_MAIN_SELECTOR = 'div#fusion-app'; // ARTICLE_SELECTOR is where Arc Publishing puts the actual article content

var ARTICLE_SELECTOR = 'div#fusion-app > div > div';
...
function hoistArticle() {
  ...
  sectionMain.parentNode.replaceChild(article, sectionMain); // Arc server-side-renders elements like links and meta tags in Spectate's index.html <head>
...
function prepareHoist(timestamp) {
  if (document.body) {
    if (document.querySelector(SECTION_MAIN_SELECTOR)) hoistArticle();else init();
    return;
  }
